...
<div class="product-form-page" style="max-width:680px;">
    ...
    <form method="POST" action="{{ route('products.store') }}">
        ...
        <hr style="border-color: var(--t-border); margin:18px 0 12px;">
        <div style="text-transform:uppercase; letter-spacing:.08em; font-size:.72rem; color: var(--t-muted); margin-bottom:10px;">Informações adicionais</div>
