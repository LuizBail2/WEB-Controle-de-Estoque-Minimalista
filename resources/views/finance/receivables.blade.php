        ...
        <div class="fin-card-body">
            <form method="POST" action="{{ route('finance.receivables.store') }}" class="row g-3">
                ...
                <div class="col-12 col-md-2">
                    <label class="fin-label">Cliente</label>
                    <input name="customer" class="fin-input" value="{{ old('customer') }}">
                </div>
    ...
    <div class="fin-card">
        <div class="fin-card-body p0">
            <table class="fin-tbl simple align-middle">
                <thead>
                    <tr>
                        <th>Descrição</th><th>Cliente</th><th class="t-end">Valor</th>
                ...
                <tbody>
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td data-label="Cliente" class="fin-muted">{{ $item->customer ?? '—' }}</td>
