        ...
        <div class="card-body">
            <form method="POST" action="{{ route('finance.payables.store') }}" class="row g-3">
                ...
                <div class="col-12 col-md-2">
                    ...
                    <input name="category" class="form-control bg-dark text-light border-secondary" placeholder="Fornecedor, Despesa fixa..." value="{{ old('category') }}">
                </div>
                ...
                <tbody>
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td data-label="Categoria" class="text-secondary">{{ $item->category ?? '—' }}</td>
